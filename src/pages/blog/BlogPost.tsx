remove Understanding Korea's Pension System.  Investing in Korean Markets.      import { Link } from "react-router-dom";
...
// List of all blog posts for navigation
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 bg-background rounded-xl p-8 shadow-md">
              ...
              {/* All posts navigation at bottom */}
              <div className="mt-12">
                <h3 className="text-xl font-semibold mb-4 text-bank-gold">
                  Explore More Articles
                </h3>
                <ul className="space-y-2">
                  {ALL_BLOG_POSTS.filter(post => post.path !== window.location.pathname)
                    .map(post => (
                      <li key={post.path}>
                        <Link
                          to={post.path}
